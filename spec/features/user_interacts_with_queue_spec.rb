...
feature "User interacts with queue" do
  scenario "user adds and reorders videos in the queue" do
    ...
    monk = FactoryGirl.create(:video, title: "Monk", category: comedies)
    south_park = FactoryGirl.create(:video, title: "South Park", category: comedies)
    futurama = FactoryGirl.create(:video, title: "Futurama", category: comedies)
